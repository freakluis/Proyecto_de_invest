...
pretestSG = [5, 5, 1, 5, 5, 5, 1, 5, 5]
postTestSG = [5, 5, 5, 5, 5, 4, 5, 5, 5]
pretestG = [5, 5, 5, 5, 5, 5, 5, 5, 4, 5, 5, 5]
postTestG = [5, 5, 5, 5, 5, 5, 5, 5, 4, 5, 5, 5]

plt.title(f'Respuestas a los reactivos de interés en pre-test y en post-test condicionSG')
#plt.style.use('fivethirtyeight')
plt.hist(pretestSG, label='series1', alpha=.8, edgecolor='red', color = "gray")
plt.hist(postTestSG, label='series2', alpha=0.7, edgecolor='yellow', color = "red")
# plt.hist(pretestG, label='series3', alpha=.8, edgecolor='red', color = "skyblue")
# plt.hist(postTestG, label='series4', alpha=0.7, edgecolor='yellow', color = "magenta")
# plt.hist(respuestas)
# plt.hist(respuestas)
